...
export default defineConfig({
    css: {
        devSourcemap: process.env.NODE_ENV === 'development' ? true : false,
    ...
    plugins: [
        ...
        basicSsl(),
        process.env.NODE_ENV === 'development' ? false : ViteMinifyPlugin({}),
        VitePWA({
            useCredentials: true,
            manifest: {
        ...
        ViteWebfontDownload(
            ...
            ], // https://fonts.google.com/share?selection.family=Source%20Sans%20Pro:ital,wght@0,200;0,300;0,400;0,600;0,700;0,900;1,200;1,300;1,400;1,600;1,700;1,900
            {
                ...
                minifyCss: process.env.NODE_ENV === 'development' ? false : true,
                async: false,
    ...
    resolve: {
        alias: {
            ...
            replacement: process.env.NODE_ENV === 'development' ? 'vue-i18n/dist/vue-i18n.esm-bundler.js' : 'vue-i18n/dist/vue-i18n.runtime.esm-bundler.js',
        }
    },
    server: {
        warmup: {
        ...
        open: true,
        port: process.env.NODE_ENV === 'development' ? 8443 : 443,
        host: 'localhost',
        origin: process.env.NODE_ENV === 'development' ? 'https://localhost:8443' : 'https://localhost:443',
        headers: {
